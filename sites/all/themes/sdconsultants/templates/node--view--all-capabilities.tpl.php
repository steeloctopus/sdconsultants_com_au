 ...
 */
    ...
    $image = field_get_items('node', $node, 'field_home_panel_image');
    $url = file_create_url($image[0]['uri']);
?>
<article id="node-<?php print $node->nid; ?>" class="capability-teaser <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
<?php if ($display_submitted): ?>
  ...
  <?php endif; ?>
    ...
    <?php if (!$page): ?>
        <h1 <?php print $title_attributes; ?> style="background-image: url(<?php print $url; ?>)">
            <a href="<?php print $node_url; ?>"><?php print $title; ?></a></h1>
    <?php endif; ?>
    <?php print render($title_suffix); ?>

  <summary <?php print $content_attributes; ?>>
